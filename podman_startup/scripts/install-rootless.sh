...
OLLAMA_BOOTSTRAP_MODELS="$(env_value OLLAMA_BOOTSTRAP_MODELS "gpt-oss:20b,rjmalagon/mxbai-rerank-large-v2:1.5b-fp16,nomic-embed-text:latest")"
...
HTTP_PROXY_VALUE="$(env_value HTTP_PROXY "$DEFAULT_PROXY")"
HTTPS_PROXY_VALUE="$(env_value HTTPS_PROXY "$DEFAULT_PROXY")"
NO_PROXY_VALUE="$(env_value NO_PROXY "$DEFAULT_NO_PROXY")"
...
write_env_line "$OLLAMA_ENV" HTTP_PROXY "$HTTP_PROXY_VALUE"
write_env_line "$OLLAMA_ENV" HTTPS_PROXY "$HTTPS_PROXY_VALUE"
write_env_line "$OLLAMA_ENV" NO_PROXY "$NO_PROXY_VALUE"
write_env_line "$OLLAMA_ENV" http_proxy "$HTTP_PROXY_VALUE"
write_env_line "$OLLAMA_ENV" https_proxy "$HTTPS_PROXY_VALUE"
write_env_line "$OLLAMA_ENV" no_proxy "$NO_PROXY_VALUE"
...
write_env_line "$OLLAMA_BOOTSTRAP_ENV" HTTP_PROXY "$HTTP_PROXY_VALUE"
write_env_line "$OLLAMA_BOOTSTRAP_ENV" HTTPS_PROXY "$HTTPS_PROXY_VALUE"
write_env_line "$OLLAMA_BOOTSTRAP_ENV" NO_PROXY "$NO_PROXY_VALUE"
write_env_line "$OLLAMA_BOOTSTRAP_ENV" http_proxy "$HTTP_PROXY_VALUE"
write_env_line "$OLLAMA_BOOTSTRAP_ENV" https_proxy "$HTTPS_PROXY_VALUE"
write_env_line "$OLLAMA_BOOTSTRAP_ENV" no_proxy "$NO_PROXY_VALUE"
...
write_env_line "$OPENWEBUI_ENV" HTTP_PROXY "$HTTP_PROXY_VALUE"
write_env_line "$OPENWEBUI_ENV" HTTPS_PROXY "$HTTPS_PROXY_VALUE"
write_env_line "$OPENWEBUI_ENV" NO_PROXY "$NO_PROXY_VALUE"
write_env_line "$OPENWEBUI_ENV" http_proxy "$HTTP_PROXY_VALUE"
write_env_line "$OPENWEBUI_ENV" https_proxy "$HTTPS_PROXY_VALUE"
write_env_line "$OPENWEBUI_ENV" no_proxy "$NO_PROXY_VALUE"
